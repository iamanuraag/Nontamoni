...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32645',
            //extent: [640186.849863, 2508162.999468, 645933.757299, 2513175.414808],
            units: 'm'})
    })
});
...
map.getView().fit([630143.483652, 2505596.074396, 650883.643979, 2516122.146609], map.getSize());
